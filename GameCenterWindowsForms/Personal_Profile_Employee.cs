...
namespace GameCenterWindowsForms
{
    public partial class Personal_Profile_Employee : Form
    {
        ...
        private void GbEmployee_Info_Enter(object sender, EventArgs e)
        {

        }

        private void TblltpnEmployee_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void LblLohgin_Click(object sender, EventArgs e)
        {
        ...
        private void LblConfermPassword_Click(object sender, EventArgs e)
        {
        ...
        private void DtpWorked_Hours_ValueChanged(object sender, EventArgs e)
        {

        }

        private void LblWorked_Hours_Click(object sender, EventArgs e)
        {

        }

        private void LblEmployee_Enterence_Click(object sender, EventArgs e)
        {

        }

        private void LblEmployee_Middle_Name_Click(object sender, EventArgs e)
        {

        }

        private void LblEmpoyee_Name_Click(object sender, EventArgs e)
        {

        }

        private void LblEmployee_First_Name_Click(object sender, EventArgs e)
        {
