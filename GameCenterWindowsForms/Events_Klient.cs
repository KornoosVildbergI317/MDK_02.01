...
{
    public partial class Events_Klient : Form
    {
        private Int32 ID_Events_Klient_Check = -1;
        public Events_Klient()
        {
            InitializeComponent();
        }

        private void Events_Klient_Check_Load(object sender, EventArgs e)
        {
        ...
        private void DgFill()
        {
            ...
            "ID_Events_Klient_Check, " +
            "Klient.First_Name_Klient as Клиент, " +
            "Events.Name_of_Events as Товар, " +
            "Events_ID, Klient_ID " +
            "FROM Events_Klient_Check " +
        ...
        {
            ID_Events_Klient_Check = (Int32)dataGridView1.Rows[e.RowIndex].Cells[0].Value;
