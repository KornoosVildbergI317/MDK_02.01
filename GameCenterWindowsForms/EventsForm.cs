...
namespace GameCenterWindowsForms
{
    ...
    public partial class EventsForm : Form
    {
        ...
        {
            ID_Events = (Int32)dataGridView1.Rows[e.RowIndex].Cells[0].Value;
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            new Procedure_Class().procedure_Execution("Events_insert", arrayList);
            DgFill();
        }
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            ArrayList arrayList = new ArrayList();
            arrayList.Add(ID_Events);
            arrayList.Add(textBoxGoods.Text);
            new Procedure_Class().procedure_Execution("Events_update", arrayList);
            DgFill();
        }
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ArrayList arrayList = new ArrayList();
            arrayList.Add(ID_Events);
            new Procedure_Class().procedure_Execution("Events_delete", arrayList);
            DgFill();
        }
